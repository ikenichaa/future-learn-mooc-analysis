...
If the archetype is significant to the course finish rate, most people with the same archetype must complete or not complete the course
...
1. Enrollment:
The enrollment data is used just for the exploratory purpose and to understand learners more. There is no direct use to answer the main questions on the archetype.
