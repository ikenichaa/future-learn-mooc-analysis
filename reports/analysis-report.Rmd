---
title: "Impact of learner archetype on study completion and study approach"
...
```{r, echo=FALSE, out.width="65%", fig.align='center', fig.cap="Number of learners by archetype in each run"}
...
scale_complete <- subset(complete_learner_archetype, select=-c(Run, `NA`)) |>
